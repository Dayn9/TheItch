...
namespace UnityEditor
{
    ...
    public class UnityPrefabBrush : GridBrushBase
    {
    ...
    [CustomEditor(typeof(UnityPrefabBrush))]
    public class PrefabBrushEditor : GridBrushEditorBase
    {
        private UnityPrefabBrush prefabBrush { get { return target as UnityPrefabBrush; } }
